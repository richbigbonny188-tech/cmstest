<?php
/* --------------------------------------------------------------
  OnGetProductNumberOfOrdersEvent.php 2020-02-18
  Gambio GmbH
  http://www.gambio.de
...
/**
 * Class OnGetProductNumberOfOrdersEvent
 * @package Gambio\Shop\SellingUnit\Database\Unit\Events
 */
class OnGetProductNumberOfOrdersEvent implements OnGetProductNumberOfOrdersEventInterface
{
    /**
