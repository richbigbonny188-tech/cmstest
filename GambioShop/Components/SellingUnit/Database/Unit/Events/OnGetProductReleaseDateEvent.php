<?php
/* --------------------------------------------------------------
  OnGetProductReleaseDateEvent.php 2020-02-19
  Gambio GmbH
  http://www.gambio.de
...
/**
 * Class OnGetProductReleaseDateEvent
 * @package Gambio\Shop\SellingUnit\Database\Unit\Events
 */
class OnGetProductReleaseDateEvent implements OnGetProductReleaseDateEventInterface
{
