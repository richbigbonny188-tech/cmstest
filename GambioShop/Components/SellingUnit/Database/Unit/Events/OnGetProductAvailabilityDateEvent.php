<?php
/* --------------------------------------------------------------
  OnGetProductAvailabilityDateEvent.php 2020-02-19
  Gambio GmbH
  http://www.gambio.de
...
/**
 * Class OnGetProductAvailabilityDateEvent
 * @package Gambio\Shop\SellingUnit\Database\Unit\Events
 */
class OnGetProductAvailabilityDateEvent implements OnGetProductAvailabilityDateEventInterface
{
    /**
    ...
    /**
     * OnGetProductAvailabilityDateEvent constructor.
     *
