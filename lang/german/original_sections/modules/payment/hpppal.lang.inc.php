...
(
    'MODULE_PAYMENT_HPPPAL_TEXT_ERROR' => 'Bei der Zahlungsverarbeitung ist in Fehler aufgetreten.',
	'MODULE_PAYMENT_HPPPAL_ALLOWED_DESC' => 'Gib <b>einzeln</b> die Zonen an, welche für dieses Modul erlaubt sein sollen. (z.B. AT,DE (wenn leer, werden alle Zonen erlaubt))',
	...
	'MODULE_PAYMENT_HPPPAL_DEBUG_DESC' => 'Schalte diesen nur auf Anweisung von heidelpay an, da sonst eine Bezahlung im Shop nicht mehr funktioniert.',
	...
	'MODULE_PAYMENT_HPPPAL_MAX_AMOUNT_DESC' => 'Wähle hier den Maximalbetrag <br>(Bitte in EURO-CENT d.h. 5 EUR = 500 Cent).',
	'MODULE_PAYMENT_HPPPAL_MAX_AMOUNT_TITLE' => 'Maximum Betrag',
	'MODULE_PAYMENT_HPPPAL_MIN_AMOUNT_DESC' => 'Wähle hier den Mindestbetrag <br>(Bitte in EURO-CENT d.h. 5 EUR = 500 Cent).',
	...
	'MODULE_PAYMENT_HPPPAL_SECURITY_SENDER_DESC' => 'Deine heidelpay Sender ID',
	...
	'MODULE_PAYMENT_HPPPAL_STATUS_DESC' => 'Möchtest du das Modul aktivieren?',
	...
	'MODULE_PAYMENT_HPPPAL_TEXT_DESC' => 'Pay Pal über heidelpay GmbH',
	'MODULE_PAYMENT_HPPPAL_TEXT_INFO' => '',
	'MODULE_PAYMENT_HPPPAL_TEXT_TITLE' => 'Pay Pal',
	'MODULE_PAYMENT_HPPPAL_TRANSACTION_CHANNEL_DESC' => 'Deine heidelpay Channel ID',
	...
	'MODULE_PAYMENT_HPPPAL_USER_LOGIN_DESC' => 'Dein heidelpay User Login',
	'MODULE_PAYMENT_HPPPAL_USER_LOGIN_TITLE' => 'User Login',
	'MODULE_PAYMENT_HPPPAL_USER_PWD_DESC' => 'Dein heidelpay User Passwort',
