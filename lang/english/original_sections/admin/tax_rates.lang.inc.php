<?php
/* --------------------------------------------------------------
	tax_rates.lang.inc.php 2015-01-05 gm
	Gambio GmbH
	http://www.gambio.de
...
(
	...
	'TEXT_INFO_TAX_RATE_PRIORITY' => 'Tax rates at the same priority are added, other rates are compounded.<br /><br />Priority:',
	'TEXT_INFO_RATE_DESCRIPTION' => 'Description:',
	'TEXT_INFO_INSERT_INTRO' => 'Please enter the new tax rate with its related data',
