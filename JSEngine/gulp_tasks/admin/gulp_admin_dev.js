 ...
 * Gulp Admin Dev Task
 *
 * This task will initialize the required sub-tasks for the admin development. It will also
		...
		ftp
			...
			.then(config => {
				...
				gulp.start(gulpsync.sync([
					'admin:clean', 'admin:vendor', 'admin:scripts', 'admin:styles',
					'jsengine:watch', 'admin:watch'
				], 'admin:dev'));
				async();
			})
			.catch(exception => {
