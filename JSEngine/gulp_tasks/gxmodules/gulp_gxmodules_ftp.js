/* --------------------------------------------------------------
 gulp_gxmodules_ftp.js 2017-03-28
 Gambio GmbH
 http://www.gambio.de
...
module.exports = function(gulp, $) {
	...
	function upload(async) {
		...
		ftp
			...
			.then(config => {
				...
				gulp.src('../GXModules/*/*/Build', {base: '.', buffer: false})
	...
	task.__description = 'Will manually upload the GXModules assets to the server (ftp-config.json is required).';
