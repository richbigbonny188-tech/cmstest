...
\Gambio\Shop\ProductModifiers\Helpers\ModifierTranslatorHelper::translateGET();

$GLOBALS['breadcrumb']->add(GM_PRICE_OFFER_NAVBAR_TITLE, xtc_href_link('gm_price_offer.php'));

$coo_price_offer_view = MainFactory::create_object('PriceOfferThemeContentView', array($_GET, $_POST));
