<?php
/* --------------------------------------------------------------
   CardShippingCostsAjaxHandler.inc.php 2022-11-08
   Gambio GmbH
   http://www.gambio.de
            ...
            switch ($t_action_request) {
                case 'get_shipping_costs':
                    ...
                    if ($t_cart_shipping_costs === false) {
                        ...
                        if (!empty($t_cart_ot_gambioultra_costs)) {
                            $coo_text_mgr = MainFactory::create_object('LanguageTextManager',
                    ...
                    $coo_cart_shipping_costs_content_view = MainFactory::create_object('CartShippingCostsThemeContentView');
