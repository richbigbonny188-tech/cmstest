<template>
  ...
  <div class="row">
    <div class="col-6">
      <select v-on:input="(e) => $emit(AddOptionEvents.ChangePreview, e)" class="form-select" id="optionType">
...
import { AddOptionEvents } from "../../../../../scripts/option/event";
