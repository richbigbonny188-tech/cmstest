<?php
/*--------------------------------------------------------------
   SummarizableTimespans.php 2021-09-20
   Gambio GmbH
   http://www.gambio.de
...
class SummarizableTimespans extends AbstractCollection
{
    ...
    {
        return $value instanceof SummarizableTimespan;
    }
     ...
     * @inheritDoc
     */
    public function current(): SummarizableTimespan
    {
