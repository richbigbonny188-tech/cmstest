<?php
/*--------------------------------------------------------------
   SalesDataProviderResult.php 2021-09-20
   Gambio GmbH
   http://www.gambio.de
...
class SalesDataProviderResult extends DataProviderResult
{
    /**
     * Constructor.
     */
    public function __construct(
        ...
        parent::__construct(new Name('sales'), $title, $unit, $style, $minimumFractionDigits, $values);
    }
}