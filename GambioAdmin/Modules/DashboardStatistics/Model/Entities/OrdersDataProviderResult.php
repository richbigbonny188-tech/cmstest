<?php
/* --------------------------------------------------------------
  OrdersDataProviderResult.php 2021-09-20
  Gambio GmbH
  http://www.gambio.de
...
class OrdersDataProviderResult extends DataProviderResult
{
    /**
     * Constructor.
     */
    public function __construct(
        ...
        parent::__construct(new Name('orders'), $title, $unit, $style, $minimumFractionDigits, $values);
    }
}