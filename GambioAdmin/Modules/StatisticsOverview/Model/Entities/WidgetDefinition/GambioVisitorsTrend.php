<?php
/*--------------------------------------------------------------
   GambioVisitorsTrend.php 2023-06-09
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class GambioVisitorsTrend extends WidgetDefinition
{
    /**
     * ID.
     */
    private const ID = 'GambioVisitorsTrend';
    ...
    public function data(WidgetOptions $options): WidgetData
    {
        ...
        foreach ($visitors as $visitor) {
            $categories[] = $this->factory->useData()->useSerialData()->createCategory($visitor['date']);
            $values[]     = $this->factory->useData()->useSerialData()->createItemValue((int)$visitor['amount']);
        }
