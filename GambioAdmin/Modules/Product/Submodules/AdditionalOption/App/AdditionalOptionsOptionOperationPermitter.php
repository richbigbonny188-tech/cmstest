<?php
/* --------------------------------------------------------------
   AdditionalOptionsOptionOperationPermitter.php 2023-06-07
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class AdditionalOptionsOptionOperationPermitter
 *
 * @package Gambio\Admin\Modules\Product\Submodules\AdditionalOption\App
 */
class AdditionalOptionsOptionOperationPermitter implements OptionOperationPermitter
{
    /**
     * AdditionalOptionsOptionOperationPermitter constructor.
     *
     * @param AdditionalOptionReader $reader
     */
    public function __construct(private AdditionalOptionReader $reader) { }
