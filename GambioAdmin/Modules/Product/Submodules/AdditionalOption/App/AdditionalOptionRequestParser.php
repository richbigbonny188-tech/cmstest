<?php
/*--------------------------------------------------------------
   AdditionalOptionRequestParser.php 2023-06-07
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class AdditionalOptionRequestParser
 *
...
{
    /**
     * AdditionalOptionApiRequestParser constructor.
     *
    ...
    /**
     * @param ServerRequestInterface|HttpRequest $request
     *
     * @return int
     */
    public function getPerPage(ServerRequestInterface|HttpRequest $request): int
    {
     ...
     * @return int
     */
    public function getPage(ServerRequestInterface|HttpRequest $request): int
    {
     ...
     * @return int
     */
    public function getLimit(ServerRequestInterface|HttpRequest $request): int
    {
     ...
     * @return int
     */
    public function getOffset(ServerRequestInterface|HttpRequest $request): int
    {
     ...
     * @return array
     */
    public function getFields(ServerRequestInterface|HttpRequest $request): array
    {
     ...
     * @return string
     */
    public function getResourceUrlFromRequest(ServerRequestInterface|HttpRequest $request): string
    {
     ...
     * @return array
     */
    public function getFilters(ServerRequestInterface|HttpRequest $request): array
    {
     ...
     * @return string|null
     */
    public function getSorting(ServerRequestInterface|HttpRequest $request): ?string
    {
