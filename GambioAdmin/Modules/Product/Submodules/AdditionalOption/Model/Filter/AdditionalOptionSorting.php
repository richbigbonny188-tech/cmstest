<?php
/* --------------------------------------------------------------
  AdditionalOptionSorting.php 2023-06-06
  Gambio GmbH
  http://www.gambio.de
...
namespace Gambio\Admin\Modules\Product\Submodules\AdditionalOption\Model\Filter;

use Gambio\Core\Filter\SqlSorting;

/**
 * Class AdditionalOptionSorting
 *
 * @package Gambio\Admin\Modules\Product\Submodules\AdditionalOption\Model\Filter
 */
class AdditionalOptionSorting extends SqlSorting
{
