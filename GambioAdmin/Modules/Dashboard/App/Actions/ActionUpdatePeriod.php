<?php
/* --------------------------------------------------------------
 ActionUpdatePeriod.php 2021-09-20
 Gambio GmbH
 http://www.gambio.de
...
/**
 * Class ActionUpdatePeriod
 *
 * @package Gambio\Admin\Modules\Dashboard\App\Actions
 * @codeCoverageIgnore
 */
class ActionUpdatePeriod extends AbstractAction
{
    ...
    /**
     * ActionUpdatePeriod constructor.
     *
    ...
    {
        if (is_string($request->getAttribute('period'))) {
            $this->statisticsService->updatePreferredPeriod($request->getAttribute('period'));
        }
