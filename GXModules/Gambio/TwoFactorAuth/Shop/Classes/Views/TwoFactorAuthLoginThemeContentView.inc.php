...
/* --------------------------------------------------------------
   TwoFactorAuthLoginThemeContentView.inc.php 2018-12-12
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class representing a two-factor-authorization front-end login content view
 */
class TwoFactorAuthLoginThemeContentView extends ThemeContentView
{
    /**
     * TwoFactorAuthLoginThemeContentView constructor.
     */
    public function __construct()
    {
        ...
        $this->set_content_data('method', TwoFactorAuthLoginControllerConfiguration::CONFIRM_URL_METHOD);
