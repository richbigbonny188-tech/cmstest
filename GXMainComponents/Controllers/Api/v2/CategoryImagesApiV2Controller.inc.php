...
/* --------------------------------------------------------------
   CategoryImagesApiV2Controller.inc.php 2019-11-11
   Gambio GmbH
   http://www.gambio.de
...
class CategoryImagesApiV2Controller extends AbstractImagesApiV2Controller
{
    ...
    public function put()
    {
        $imageJsonString = json_encode($this->request->getParsedBody());
        
        if (empty($imageJsonString) || $this->request->getParsedBody() === null) {
    ...
    public function delete()
    {
        ...
        $imageJsonObject = json_decode($imageJsonString);
     ...
     *             curl -i --user admin@example.org:12345 https://example.org/api.php/v2/category_images
     */
    public function get()
    {
        parent::get();
