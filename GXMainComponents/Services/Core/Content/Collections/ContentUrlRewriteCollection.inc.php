...
/* --------------------------------------------------------------
   ContentUrlRewriteCollection.inc.php 2019-04-12
   Gambio GmbH
   http://www.gambio.de
 ...
 * @package    Content
 */
class ContentUrlRewriteCollection extends AbstractLocalizedContentAttributeCollection
{
    /**
    ...
    {
        return ContentUrlRewrite::class;
    }
}