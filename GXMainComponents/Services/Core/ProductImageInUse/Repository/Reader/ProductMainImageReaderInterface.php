<?php
/* --------------------------------------------------------------
   ProductMainImageReaderInterface.php 2023-11-29
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Interface ProductMainImageReaderInterface
 *
...
{
    /**
     * Returns an array of `ProductImageNameDTO` with the main images path in use
     *
    ...
    /**
     * Returns whether the main image is in use
     *
