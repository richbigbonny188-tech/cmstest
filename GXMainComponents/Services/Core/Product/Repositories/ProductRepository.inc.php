<?php
/* --------------------------------------------------------------
   ProductRepository.inc.php 2021-09-27
   Gambio GmbH
   http://www.gambio.de
...
class ProductRepository implements ProductRepositoryInterface
{
    ...
    public function __construct(
        ProductRepositoryReaderInterface $reader,
    ...
    {
        return $this->reader->getProductsCount();
    }
     ...
     * @inheritDoc
     */
    public function countImageUsage(ProductImageInterface $productImage): int
    {
        return $this->reader->countImageUsage($productImage->getFilename());
    }
}