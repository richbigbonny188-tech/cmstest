<?php
/* --------------------------------------------------------------
   PersonalDataServiceSettings.inc.php 2018-05-16
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class PersonalDataServiceSettings implements PersonalDataServiceSettingsInterface
{
    /**
    ...
    {
        return DIR_FS_CATALOG . 'export/personal_data/';
    }
    ...
    {
        return DIR_FS_DOCUMENT_ROOT . 'export/personal_data/';
    }
}