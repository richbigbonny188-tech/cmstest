<?php
/* --------------------------------------------------------------
   FilterSelectionThemeContentView.inc.php 2018-11-19
   Gambio GmbH
   http://www.gambio.de
...
class FilterSelectionThemeContentView extends ThemeContentView
{
    ...
    public function __construct()
    {
        ...
        $this->set_content_template('filter.html');
    ...
    protected function set_validation_rules()
    {
        ...
        $this->validation_rules_array['feature_value_group_array'] = ['type' => 'array'];
        $this->validation_rules_array['coo_feature_set_source']    = [
            'type'        => 'object',
    ...
    {
        $t_uninitialized_array = $this->get_uninitialized_variables(['language_id', 'feature_value_group_array']);
    ...
    protected function get_feature_data($p_feature_id, $p_feature_values)
    {
        ...
        if (xtc_db_num_rows($t_result) == 1) {
            ...
            $t_feature_array['feature_values'] = [];
            ...
            $t_feature_array['feature_name']   = '';
            $t_feature_array['feature_values'] = [];
    
            foreach ($p_feature_values as $t_feature_value_id) {
                $t_feature_array['feature_values'][$t_feature_value_id] = '';
            }
        }
    ...
    {
        $t_selected_feature_values_id_array = [];
