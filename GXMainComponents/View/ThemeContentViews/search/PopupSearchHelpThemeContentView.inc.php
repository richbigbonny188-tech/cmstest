<?php
/* --------------------------------------------------------------
  PopupSearchHelpThemeContentView.inc.php 2018-11-13
  Gambio GmbH
  http://www.gambio.de
...
class PopupSearchHelpThemeContentView extends ThemeContentView
{
    public function __construct()
    {
        parent::__construct();
        $this->set_content_template('popup_search_help.html');
