<?php
/* --------------------------------------------------------------
	PayoneCheckoutCreditRiskThemeContentView.inc.php 2018-11-13
	Gambio GmbH
	http://www.gambio.de
...
class PayoneCheckoutCreditRiskThemeContentView extends ThemeContentView
{
    protected $_payone;
    ...
    {
        $this->set_content_template('checkout_payment_payone_cr.html');
