<?php
/* --------------------------------------------------------------
	PayoneCheckoutAddressCheckThemeContentView.inc.php 2018-11-13
	Gambio GmbH
	http://www.gambio.de
...
class PayoneCheckoutAddressCheckThemeContentView extends ThemeContentView
{
    protected $_payone;
    ...
    {
        $this->set_content_template('checkout_payment_payone_addresscheck.html');
    }
    ...
    protected function _checkAddresses()
    {
        ...
        if ($config['address_check']['billing_address'] != 'none') {
            ...
            if ($billto_check instanceof Payone_Api_Response_AddressCheck_Invalid) {
                ...
                $customermessage = str_replace('{payone_error}',
                                               $billto_check->getCustomermessage(),
                                               $config['address_check']['error_message']);
                ...
                if ($billto_check instanceof Payone_Api_Response_AddressCheck_Valid) {
        ...
        if ($config['address_check']['delivery_address'] != 'none') {
            ...
            if ($sendto_check instanceof Payone_Api_Response_AddressCheck_Invalid) {
                ...
                $customermessage = str_replace('{payone_error}',
                                               $sendto_check->getCustomermessage(),
                                               $config['address_check']['error_message']);
                ...
                if ($sendto_check instanceof Payone_Api_Response_AddressCheck_Valid) {
