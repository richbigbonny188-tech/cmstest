...
$coo_whats_new = MainFactory::create_object('WhatsNewBoxThemeContentView');
$coo_whats_new->set_('coo_product', $this->coo_product);
if (empty($_GET['products_id']) === false) {
    $coo_whats_new->set_('products_id', (int)xtc_get_prid($_GET['products_id']));
}
