<?php
/* --------------------------------------------------------------
   xtc_encrypt_password.inc.php 2016-09-09
   Gambio GmbH
   http://www.gambio.de
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com (xtc_encrypt_password.inc.php 899 2005-04-29 02:40:57Z hhgag $)
...
function xtc_encrypt_password($plain)
{
	...
	return $authService->getHash(new StringType($plain));
}