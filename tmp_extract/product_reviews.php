<?php
/* --------------------------------------------------------------
  product_reviews.php 2022-08-04
  Gambio GmbH
  http://www.gambio.de
...
{
	$coo_product_reviews_control->set_('products_id', (int)$_GET['products_id']);
}
$coo_product_reviews_control->set_('language_id', (int)($_SESSION['languages_id'] ?? null));
