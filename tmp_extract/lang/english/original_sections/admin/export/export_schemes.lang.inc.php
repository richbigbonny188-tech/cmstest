...
$t_language_text_section_content_array = [
    ...
    'amount_additional_image_files'               => 'Amount of additional images',
    ...
    'collective_field_source'                     => 'Product Variants/Product Options/Additional fields (\';\' separated)',
    'collective_field_sources'                    => 'Var./Opt./Addit.',
    'columns'                                     => 'Column',
    ...
    'delete_products_warning'                     => 'WARNING! If all products are deleted, the following data is also deleted (reviews, product options, product variants, cross-selling products, specials, images, url-rewrites)',
    'delete_properties'                           => 'Delete all product variants allocations in the store?',
    'delete_reviews'                              => 'Delete all reviews in the store?',
    'delete_rewrite_urls'                         => 'Delete all rewrite urls of products in the store?',
    ...
    'export_all_new_ones'                         => 'Export all future added categories',
    ...
    'export_properties'                           => 'Product Variants',
    'export_property_image'                       => 'Use product variant image instead of product image',
    ...
    'no_export_scheme'                            => 'Manually export is not available while an export by cronjob is running.',
    'or'                                          => 'or',
    ...
    'properties_selection'                        => 'Product variants selection',
    ...
    'tooltip_amount_additional_image_files'       => 'Enter here the maximal number ob images, which should be exported in the \'Zusätzliche Bilderlinks\' (additional image URLs) column.',
    'tooltip_collective_fields'                   => 'Collective fields are used to select values from different sources in one column. You can supply multiple names of product variants, product options and additional fields from which the value is selected.<br/><br/><i>Column name:</i><br/>The column name will be the title of the column which is displayed at the top of the exported CSV file.<br/><br/><i>Product Variants/Product Options/Additional fields:</i><br/>In this input field you can supply multiple names of product variants, product options and/or additional fields as a \';\' separated list of which the value is chosen (i.e. Color;Varnish;Wall paint).<br/><br/><i>Default content:</i><br/>This will be set as value, if no suitable value could be selected from any of the sources.<br/><br/><i>Var./Opts./Addit.:</i><br/>With these checkboxes you can choose which sources should be searched to find the supplied names. To raise the performance of the export, it is recommended to uncheck the checkboxes of sources that you are not using.<br/><br/><i>Note:</i><br/>If multiple values from different sources are found, the following prioritization applies:<br/>- Product variants (highest priority)<br/>- Product Options<br/>- Additional fields (lowest priority)',
    ...
    'tooltip_conf_export_properties_checkbox'     => 'Select if you want to include product variants of products when creating export files of the type \'Price Comparison\'<br/>Notice: product variant combinations are considered separate products in the export file.',
    'tooltip_conf_export_property_image_checkbox' => 'Select if you want to export the product variant image instead of the product image. This will only be done, if a product variant image was added.',
    ...
    'tooltip_import_file_extension'               => 'Please select your import file (possible file types: .txt, .csv)',
