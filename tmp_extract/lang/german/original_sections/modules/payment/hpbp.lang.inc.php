...
(
    'MODULE_PAYMENT_HPBP_TEXT_ERROR' => 'Bei der Zahlungsverarbeitung ist in Fehler aufgetreten.',
	'MODULE_PAYMENT_HPBP_ALLOWED_DESC' => 'Gib <b>einzeln</b> die Zonen an, welche für dieses Modul erlaubt sein sollen. (z.B. AT,DE (wenn leer, werden alle Zonen erlaubt))',
	...
	'MODULE_PAYMENT_HPBP_DEBUG_DESC' => 'Schalte diesen nur auf Anweisung von heidelpay an, da sonst eine Bezahlung im Shop nicht mehr funktioniert.',
	...
	'MODULE_PAYMENT_HPBP_DIRECT_MODE_DESC' => 'Wenn Modul Mode auf DIRECT, dann wähle hier ob die Zahldaten auf einer Extraseite oder in einer Lightbox eingegeben werden sollen.',
	...
	'MODULE_PAYMENT_HPBP_MAX_AMOUNT_DESC' => 'Wähle hier den Maximalbetrag <br>(Bitte in EURO-CENT d.h. 5 EUR = 500 Cent).',
	'MODULE_PAYMENT_HPBP_MAX_AMOUNT_TITLE' => 'Maximum Betrag',
	'MODULE_PAYMENT_HPBP_MIN_AMOUNT_DESC' => 'Wähle hier den Mindestbetrag <br>(Bitte in EURO-CENT d.h. 5 EUR = 500 Cent).',
	...
	'MODULE_PAYMENT_HPBP_PAY_MODE_DESC' => 'Wähle zwischen Debit (DB) und Preauthorisation (PA).',
	...
	'MODULE_PAYMENT_HPBP_SECURITY_SENDER_DESC' => 'Deine heidelpay Sender ID',
	...
	'MODULE_PAYMENT_HPBP_STATUS_DESC' => 'Möchtest du das Modul aktivieren?',
	'MODULE_PAYMENT_HPBP_STATUS_TITLE' => 'Modul aktivieren',
	'MODULE_PAYMENT_HPBP_SYSTEM_DESC' => 'Wähle hier das heidelpay System.',
	...
	'MODULE_PAYMENT_HPBP_TEXT_DESC' => 'BarPay über heidelpay GmbH',
	...
	'MODULE_PAYMENT_HPBP_TRANSACTION_CHANNEL_DESC' => 'Deine heidelpay Channel ID',
	'MODULE_PAYMENT_HPBP_TRANSACTION_CHANNEL_TITLE' => 'Channel ID',
	'MODULE_PAYMENT_HPBP_TRANSACTION_MODE_DESC' => 'Wähle hier den Transaktionsmodus.',
	'MODULE_PAYMENT_HPBP_TRANSACTION_MODE_TITLE' => 'Transaction Mode',
	'MODULE_PAYMENT_HPBP_USER_LOGIN_DESC' => 'Dein heidelpay User Login',
	'MODULE_PAYMENT_HPBP_USER_LOGIN_TITLE' => 'User Login',
	'MODULE_PAYMENT_HPBP_USER_PWD_DESC' => 'Dein heidelpay User Passwort',
