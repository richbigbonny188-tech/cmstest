...
$coo_specials_view = MainFactory::create_object('SpecialsPageThemeContentView');
$coo_specials_view->set_('coo_product', $GLOBALS['product']);
$coo_specials_view->set_('language_id', (int)($_SESSION['languages_id'] ?? null));
