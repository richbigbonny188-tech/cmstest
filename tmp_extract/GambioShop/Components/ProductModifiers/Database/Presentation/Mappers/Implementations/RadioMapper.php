...
use Gambio\Shop\ProductModifiers\Presentation\Implementations\Radio\RadioType;

/**
 * Class RadioInfoMapper
 * @package Gambio\Shop\ProductModifiers\Database\Presentation\Mappers
 */
class RadioMapper extends AbstractPresentationMapper
{
    
    /**
     * RadioInfoMapper constructor.
     *
     * @param RadioInfoBuilder $builder
     */
    public function __construct(RadioInfoBuilder $builder)
    {
    ...
    {
        return $dto->type() === RadioType::type();
    }
