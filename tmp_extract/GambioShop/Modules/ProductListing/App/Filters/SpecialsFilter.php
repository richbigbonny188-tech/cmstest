 ...
 */
class SpecialsFilter implements ListingFilter
{
    ...
    /**
     * Builds a sql statement fetching ids for products that should appear on specials page.
     * This method also takes group and fsk checks into account.
     *
     * @return Result
     * @see \SpecialsPageThemeContentView::generate_data()
     *
     */
