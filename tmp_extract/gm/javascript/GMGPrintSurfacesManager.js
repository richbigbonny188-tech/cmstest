...
#   --------------------------------------------------------------
#   GMGPrintSurfacesManager.js 2018-07-13
#   Gambio GmbH
#   http://www.gambio.de
...
function GMGPrintSurfacesManager(p_surfaces_groups_id, p_coo_gprint_configuration)
{
    ...
    this.create_surface = function(p_names, p_width, p_height)
	{
        ...
        var t_surfaces_id = jQuery.ajax({
            data: 'action=create_surface&surfaces_groups_id=' + c_surfaces_groups_id + '&' + t_surfaces_names + '&width=' + c_width + '&height=' + c_height + '&mode=' + c_mode + '&page_token=' + this.page_token,
    ...
    this.load_surfaces_group = function(p_surfaces_groups_id, p_product)
	{
		...
		jQuery.ajax({
            data: 'action=load_surfaces_group&surfaces_groups_id=' + c_surfaces_groups_id + '&mode=' + c_mode + '&page_token=' + this.page_token + '&product=' + c_product,
            url: 'request_port.php?module=GPrint',
            dataType: 'json',
            type: "POST",
            async: false,
	...
	this.show = function()
	{
		...
		if (window.jse && window.location.pathname.indexOf('gm_gprint.php') <= 5
			&& typeof jse.libs.theme.events !== 'undefined') {
    ...
    this.delete_surface = function(p_surfaces_id)
	{
    	...
    	var t_success = jQuery.ajax({
            data: 'action=delete_surface&surfaces_id=' + c_surfaces_id + '&mode=' + c_mode + '&page_token=' + this.page_token,
            url: 'request_port.php?module=GPrint',
            type: "POST",
            async: false
        }).responseText;
	...
	this.update_current_surfaces_id = function(p_surfaces_id)
	{
		...
		var t_success = jQuery.ajax({
            data: 'action=set_current_surfaces_id&surfaces_id=' + c_surfaces_id + '&mode=' + c_mode + '&page_token=' + this.page_token,
            url: 'request_port.php?module=GPrint',
            type: "POST",
            async: false
        }).json;
	...
	this.update_name = function(p_name)
	{
		...
		jQuery.ajax({
            data: 'action=update_surfaces_group&surfaces_groups_id=' + c_surfaces_groups_id + '&name=' + c_name + '&mode=' + c_mode + '&page_token=' + this.page_token,
            url: 'request_port.php?module=GPrint',
            dataType: 'json',
            type: "POST",
            async: false,
