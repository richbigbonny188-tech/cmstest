...
//		$('.wrap_site').append('<div id="gm_show_tell_a_friend"></div>');
		...
		$('#gm_show_tell_a_friend').load('request_port.php?module=TellAFriend&action=get_form&id=' + $("#gm_products_id").attr('value'),
	...
	this.send_form = function(){
		...
		jQuery.ajax({
			data: 		inputs.join('&'),
			url: 			'request_port.php?module=TellAFriend&action=get_form&id=' + $("#gm_products_id").attr('value'),
			type: 		"POST",
