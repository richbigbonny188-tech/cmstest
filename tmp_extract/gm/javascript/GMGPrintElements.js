...
#   --------------------------------------------------------------
#   GMGPrintElements.js 2018-06-15
#   Gambio GmbH
#   http://www.gambio.de
...
function GMGPrintElements(p_elements_id)
{
	...
	this.set_element_names = function(p_names) {
		...
		var invalid_element_names = false;
		
		for (t_languages_id in p_names) {
			$('#current_element_name_'+t_languages_id).removeClass('error');
			if (p_names[t_languages_id] === '') {
				$('#current_element_name_'+t_languages_id).addClass('error');
				invalid_element_names = true;
			}
			...
			t_elements_names +=
				'names[' + encodeURIComponent(t_languages_id) + ']=' + encodeURIComponent(p_names[t_languages_id]);
		}
		
		if (!invalid_element_names) {
			var c_elements_id = encodeURIComponent(this.get_elements_id());
			var t_success = jQuery.ajax({
				data: 'action=set_element_names&elements_id=' + c_elements_id + '&' + t_elements_names + '&mode='
				+ c_mode + '&page_token=' + this.page_token,
    ...
    this.set_element_values = function(p_values, p_languages_id)
	{
        ...
        var t_success = jQuery.ajax({
            data: 'action=set_element_values&elements_id=' + c_elements_id + '&' + t_elements_values + '&mode=' + c_mode + '&page_token=' + this.page_token,
            url: 'request_port.php?module=GPrint',
            type: "POST",
            async: false
        }).responseText;
    ...
    this.set_size = function(p_width, p_height)
	{
        ...
        var t_success = jQuery.ajax({
            data: 'action=set_element_size&elements_id=' + c_elements_id + '&width=' + c_width + '&height=' + c_height + '&mode=' + c_mode + '&page_token=' + this.page_token,
            url: 'request_port.php?module=GPrint',
            type: "POST",
            async: false
        }).responseText;
    ...
    this.set_position = function(p_position_x, p_position_y)
	{
    	...
    	var t_success = jQuery.ajax({
            data: 'action=set_element_position&elements_id=' + c_elements_id + '&position_x=' + c_position_x + '&position_y=' + c_position_y + '&mode=' + c_mode + '&page_token=' + this.page_token,
            url: 'request_port.php?module=GPrint',
            type: "POST",
            async: false
        }).responseText;
    ...
    this.set_element_z_index = function(p_z_index)
	{
    	...
    	var t_success = jQuery.ajax({
            data: 'action=set_element_z_index&elements_id=' + c_elements_id + '&z_index=' + c_z_index + '&mode=' + c_mode + '&page_token=' + this.page_token,
            url: 'request_port.php?module=GPrint',
            type: "POST",
            async: false
        }).responseText;
    ...
    this.set_element_max_characters = function(p_max_characters)
	{
    	if(this.get_type() == 'text_input' || this.get_type() == 'textarea')
    	{
        	...
        	var t_success = jQuery.ajax({
                data: 'action=set_element_max_characters&elements_id=' + c_elements_id + '&max_characters=' + c_max_characters + '&mode=' + c_mode + '&page_token=' + this.page_token,
                url: 'request_port.php?module=GPrint',
                type: "POST",
                async: false
            }).responseText;
    ...
    this.set_element_show_name = function(p_show_name)
	{
    	if(this.get_type() == 'text_input' || this.get_type() == 'textarea' || this.get_type() == 'dropdown')
    	{
        	...
        	var t_success = jQuery.ajax({
                data: 'action=set_element_show_name&elements_id=' + c_elements_id + '&show_name=' + c_show_name + '&mode=' + c_mode + '&page_token=' + this.page_token,
                url: 'request_port.php?module=GPrint',
                type: "POST",
                async: false
            }).responseText;
    ...
    this.set_element_allowed_extensions = function(p_allowed_extensions)
	{
    	if(this.get_type() == 'file')
    	{
        	...
        	var t_success = jQuery.ajax({
                data: 'action=set_element_allowed_extensions&elements_id=' + c_elements_id + '&allowed_extensions=' + c_allowed_extensions + '&mode=' + c_mode + '&page_token=' + this.page_token,
                url: 'request_port.php?module=GPrint',
                type: "POST",
                async: false
            }).responseText;
    ...
    this.set_element_minimum_filesize = function(p_minimum_filesize)
	{
    	if(this.get_type() == 'file')
    	{
        	...
        	var t_success = jQuery.ajax({
                data: 'action=set_element_minimum_filesize&elements_id=' + c_elements_id + '&minimum_filesize=' + c_minimum_filesize + '&mode=' + c_mode + '&page_token=' + this.page_token,
                url: 'request_port.php?module=GPrint',
                type: "POST",
                async: false
            }).responseText;
    ...
    this.set_element_maximum_filesize = function(p_maximum_filesize)
	{
    	if(this.get_type() == 'file')
    	{
        	...
        	var t_success = jQuery.ajax({
                data: 'action=set_element_maximum_filesize&elements_id=' + c_elements_id + '&maximum_filesize=' + c_maximum_filesize + '&mode=' + c_mode + '&page_token=' + this.page_token,
                url: 'request_port.php?module=GPrint',
                type: "POST",
                async: false
            }).responseText;
