<?php
/* --------------------------------------------------------------
   LithuaniaVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class LithuaniaVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class LithuaniaVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('lt', '', strtolower($vatId));
        if (strlen($vatId) == 11) {
