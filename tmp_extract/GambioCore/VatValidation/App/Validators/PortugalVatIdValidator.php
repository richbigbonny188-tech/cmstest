<?php
/* --------------------------------------------------------------
   PortugalVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class PortugalVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class PortugalVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('pt', '', strtolower($vatId));
        if (strlen($vatId) == 11) {
