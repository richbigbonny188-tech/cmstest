<?php
/* --------------------------------------------------------------
   PolandVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class PolandVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class PolandVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('pl', '', strtolower($vatId));
        if (strlen($vatId) == 12) {
