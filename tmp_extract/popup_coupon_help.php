<?php
/* --------------------------------------------------------------
   popup_coupon_help.php 2022-08-02
   Gambio GmbH
   http://www.gambio.de
...
$coo_popup_coupon_help = MainFactory::create_object('PopupCouponHelpThemeContentView');
$coo_popup_coupon_help->set_('coupon_id', (int)$_GET['cID']);
$coo_popup_coupon_help->set_('language_id', (int)($_SESSION['languages_id'] ?? null));
