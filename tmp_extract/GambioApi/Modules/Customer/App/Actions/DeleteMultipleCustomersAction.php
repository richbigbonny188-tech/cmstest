<?php
/*--------------------------------------------------------------
   DeleteMultipleCustomersAction.php 2022-03-23
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class DeleteMultipleCustomersAction
 *
...
class DeleteMultipleCustomersAction
{
    ...
    {
        try {
            $customerIds = $request->getAttribute('customerIds');
            $customerIds = array_map('intval', explode(',', $customerIds));
            $this->service->deleteCustomers(...$customerIds);
