<?php
/* --------------------------------------------------------------
	InternetMarkeText.inc.php 2016-02-08
	Gambio GmbH
	http://www.gambio.de
...
class InternetMarkeText
{
	...
	public function __construct($languages_id = null)
	{
		...
		$this->languageTextManager = MainFactory::create_object('LanguageTextManager', array('internetmarke', $languages_id));
	}
