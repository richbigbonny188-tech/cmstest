...
{
	xtc_redirect(GM_HTTP_SERVER . DIR_WS_CATALOG . 'admin/customers/' . (int)$_SESSION['customer_id']);
}
...
$coo_account_edit->set_('customer_id', (int)$_SESSION['customer_id']);
