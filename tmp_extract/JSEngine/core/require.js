...
(function () {
    ...
    let readyRegExp = isBrowser && navigator.platform === 'PLAYSTATION 3' ? /^complete$/ : /^(complete|loaded)$/;
    ...
    function newContext(contextName) {
        ...
        Module.prototype = {
            ...
            callPlugin: function () {
                ...
                let pluginMap = makeModuleMap(map.prefix);
        ...
        context = {
            ...
            completeLoad: function (moduleName) {
                ...
                let args;
                let mod;
                let shim = getOwn(config.shim, moduleName) || {};
                let shExports = shim.exports;
            ...
            nameToUrl: function (moduleName, ext, skipExt) {
                ...
                let parentModule;
                let url;
                let parentPath, bundleId;
                let pkgMain = getOwn(config.pkgs, moduleName);
