/* --------------------------------------------------------------
 gulp_general_ftp.js 2016-09-23
 Gambio GmbH
 http://www.gambio.de
...
module.exports = function(gulp, $) {
	...
	function upload(async) {
		...
		ftp
			...
			.then(config => {
				...
				gulp.src('../JSEngine/build/**', {base: '.', buffer: false})
	...
	task.__description = 'Will manually upload the JSEngine assets to the server (ftp-config.json is required).';
