...
// Outputs a button in the selected language
  function xtc_image_submit($image, $alt = '', $parameters = '') {
    ...
    $image_submit = '<input type="image" src="' . xtc_parse_input_field_data(StaticGXCoreLoader::getThemeControl()->getThemeImagePath().'buttons/' . $_SESSION['language'] . '/'. $image, array('"' => '&quot;')) . '" alt="' . xtc_parse_input_field_data($alt, array('"' => '&quot;')) . '"';
