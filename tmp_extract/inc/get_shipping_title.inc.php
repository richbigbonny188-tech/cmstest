...
function get_shipping_title($p_methodName, $p_languageDirectoryName = '', $p_stripTags = true)
{
	if($p_stripTags)
	{
		return ShippingTitleProvider::getStrippedTagsTitle($p_methodName, $p_languageDirectoryName);
	}
	
	return ShippingTitleProvider::getTitle($p_methodName, $p_languageDirectoryName);
}