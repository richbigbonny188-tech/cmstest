<?php
/*--------------------------------------------------------------------
 PropertiesCombisAjaxHandler.inc.php 2020-2-17
 Gambio GmbH
 http://www.gambio.de
 ...
 -------------------------------------------------------------------*/
require_once(__DIR__ . '/../../../gm/classes/JSON.php');
    ...
    function proceed()
    {
        ...
        switch($t_action_request)
        {
            case 'get_selection_template':
				...
				$t_initial = isset($this->v_data_array['POST']['initial']) && $this->v_data_array['POST']['initial'] === 'true';
    
                $t_output_array = array_merge($coo_properties_control->get_selection_data($c_products_id,
                                                                                          ...
                                                                                          $t_initial),
                                              ['properties_values' => $t_properties_values]);
