<?php
/* --------------------------------------------------------------
	PaymentInstructionSendOrderThemeContentView.inc.php 2018-12-12
	Gambio GmbH
	http://www.gambio.de
...
class PaymentInstructionSendOrderThemeContentView extends PaymentInstructionSendOrderThemeContentView_parent
{
    ...
    protected function _makePaymentInstructionText($paymentInstruction)
    {
        ...
        $textLines = array(
            ...
            $paymentInstructionText->get_text('amount') . ': ' . sprintf("%.2f %s", $paymentInstruction['value'],
