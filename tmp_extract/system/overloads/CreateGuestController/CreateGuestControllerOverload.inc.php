<?php
/* --------------------------------------------------------------
   CreateGuestControllerOverload.inc.php 2018-05-23
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class CreateGuestControllerOverload
 *
 ...
 */
class CreateGuestControllerOverload extends CreateGuestControllerOverload_parent
{
		...
		if($httpResponse instanceof RedirectHttpControllerResponse)
		{
			...
			catch(InvalidCustomerDataException $e)
			{
				return $this->_getResponse($this->_getMainContentHtml($customerCollection,
				                                                      $e->getErrorMessageCollection(), true));
			}
		}
