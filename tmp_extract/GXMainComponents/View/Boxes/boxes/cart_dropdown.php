...
$coo_content_view = MainFactory::create_object('ShoppingCartDropdownBoxThemeContentView');
...
$coo_content_view->set_('customers_status_ot_discount_flag',
                        $_SESSION['customers_status']['customers_status_ot_discount_flag']);
$coo_content_view->set_('customers_status_ot_discount', $_SESSION['customers_status']['customers_status_ot_discount']);
$coo_content_view->set_('customers_status_show_price_tax',
...
$coo_content_view->set_('customers_status_payment_unallowed',
...
$coo_content_view->set_cart_head_template();
$t_html = $coo_content_view->get_html();
