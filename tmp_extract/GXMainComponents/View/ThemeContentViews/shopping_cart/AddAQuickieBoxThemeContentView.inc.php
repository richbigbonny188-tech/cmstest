<?php
/* --------------------------------------------------------------
   AddAQuickieBoxThemeContentView.inc.php 2018-11-13
   Gambio GmbH
   http://www.gambio.de
...
class AddAQuickieBoxThemeContentView extends ThemeContentView
{
    public function __construct()
    {
        parent::__construct();
        $this->set_content_template('box_add_a_quickie.html');
    ...
    public function prepare_data()
    {
        ...
        $this->content_array['FORM_ACTION_URL'] = xtc_href_link(basename(gm_get_env_info('PHP_SELF')),
                                                                xtc_get_all_get_params(['action'])
                                                                . 'action=add_a_quickie',
                                                                'NONSSL',
                                                                true,
                                                                true,
                                                                true);
