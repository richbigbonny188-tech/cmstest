<?php
/* --------------------------------------------------------------
   AccountDeleteThemeContentView.inc.php 2018-11-13
   Gambio GmbH
   http://www.gambio.de
...
class AccountDeleteThemeContentView extends ThemeContentView
{
    public function __construct()
    {
        parent::__construct();
        $this->set_content_template('account_delete.html');
