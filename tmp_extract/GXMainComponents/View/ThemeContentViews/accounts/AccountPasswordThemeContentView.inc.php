<?php
/* --------------------------------------------------------------
  AccountPasswordThemeContentView.inc.php 2018-11-13
  Gambio GmbH
  http://www.gambio.de
...
class AccountPasswordThemeContentView extends ThemeContentView
{
    ...
    public function __construct()
    {
        ...
        $this->set_content_template('account_change_password.html');
    ...
    protected function add_form()
    {
        ...
        $this->content_array['form_data']['password_hidden_action'] = [];;
    ...
    {
        $this->content_array['form_data']['password_current']             = [];
    ...
    {
        $this->content_array['form_data']['password_new']             = [];
    ...
    {
        $this->content_array['form_data']['password_confirmation']             = [];
