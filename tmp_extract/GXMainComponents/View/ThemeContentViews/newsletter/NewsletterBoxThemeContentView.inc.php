<?php
/* --------------------------------------------------------------
   NewsletterThemeContentView.inc.php 2018-11-13
   Gambio GmbH
   http://www.gambio.de
...
class NewsletterBoxThemeContentView extends ThemeContentView
{
    public function __construct()
    {
        parent::__construct();
        $this->set_content_template('box_newsletter.html');
    }
