<?php
/* --------------------------------------------------------------
   EnvInvoiceServiceSettings.inc.php 2016-10-06
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class EnvInvoiceServiceSettings implements InvoiceServiceSettingsInterface
{
    /**
    ...
    {
        $path = DIR_FS_CATALOG . 'export/invoice/';
