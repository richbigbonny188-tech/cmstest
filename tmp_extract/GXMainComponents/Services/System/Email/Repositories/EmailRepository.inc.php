<?php
/* --------------------------------------------------------------
   EmailRepository.php 2018-06-07
   Gambio GmbH
   http://www.gambio.de
...
class EmailRepository implements EmailRepositoryInterface
{
    ...
    {
        $collection = $this->reader->get(['email_id' => (int)(string)$id]);
    ...
    {
        return $this->reader->get(['is_pending' => true]);
    }
    ...
    {
        return $this->reader->get(['is_pending' => false]);
    }
    ...
    {
        $this->deleter->deleteEmailsByEmailAddress($email);
    }
     ...
     */
    public function getEmailsByEmailAddress(CustomerEmail $email)
    {
        return $this->reader->filter((string)$email);
    }
    ...
    {
        return $this->deleter->deleteOldEmailsByDate($date);
    }
}