<?php
/* --------------------------------------------------------------
   PayPalHubPaymentDetailsProvider.inc.php 2018-06-22
   Gambio GmbH
   http://www.gambio.de
...
class PayPalHubPaymentDetailsProvider implements PaymentDetailsProvider
{
    public function getDetails(IdType $orderId)
    {
        ...
        try {
            ...
            $response = $hubCallbackApiClient->execute('PayPalHub', true, ['source' => 'payment_details'], $query);
