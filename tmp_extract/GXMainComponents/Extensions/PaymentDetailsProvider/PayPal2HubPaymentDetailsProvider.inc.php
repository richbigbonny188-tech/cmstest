<?php
/* --------------------------------------------------------------
   PayPal2HubPaymentDetailsProvider.inc.php 2019-09-26
   Gambio GmbH
   http://www.gambio.de
...
class PayPal2HubPaymentDetailsProvider implements PaymentDetailsProvider
{
    public function getDetails(IdType $orderId)
    {
        ...
        try {
            ...
            $response = $hubCallbackApiClient->execute('PayPal2Hub', true, ['source' => 'payment_details'], $query);
