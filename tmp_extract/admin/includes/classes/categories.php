...
// insert_product ends
	...
	protected function duplicate_product_content($srcId, $dupId)
	{
	 ...
	 * @return bool
	 */
	protected function duplicate_gxcustumizer_set_assignment($p_productIdSrc, $p_productIdTarget)
	{
