<?php
/* --------------------------------------------------------------
  image_manipulator_GD2.php 2020-12-10 gm
  Gambio GmbH
  http://www.gambio.de
...
{
	function __construct($resource_file, $max_width = 1, $max_height = 1, $destination_file = "", $compression = IMAGE_QUALITY, $transform = "")
	{
