...
<?php
    ...
    // EOF GM_MOD
        ...
        do {
            ...
            echo "<td class=\"dataTableHeadingContent\">".htmlspecialchars($row["products_name"])."</td>\n";
            echo "<td class=\"dataTableHeadingContent\">".htmlspecialchars($row["products_model"])."</td>\n";
            echo "</tr>\n";
        }
