...
/* --------------------------------------------------------------
  ...
  (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: listproducts.php 1312 2005-10-18 14:18:20Z mz $)
   ...
   $get_result=xtc_db_fetch_array($coupon_get);
    ...
    for ($i = 0; $i < count($pr_ids); $i++) {
      ...
      if ($row = xtc_db_fetch_array($result)) {
            ...
            echo "<td>".htmlspecialchars($row["products_model"])."</td>\n";
            echo "</tr>\n";
      }
    }
      echo "</table>\n";
