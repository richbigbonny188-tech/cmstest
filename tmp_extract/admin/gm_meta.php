									...
									<div class="gx-container">
										<div class="ui-tabs">
											<div class="tab-headline-wrapper" style="position: static; top: 0;">
												...
												// Meta Tags
												$class = ((isset($_GET['action']) && $_GET['action'] === 'gm_meta') || !isset($_GET['action']))
														? 'active' : '';
												...
												// New Meta Tags
												$class = (isset($_GET['action']) && $_GET['action'] === 'gm_meta_new')
														? 'active' : '';
												...
												// Meta Tags Options
												$class = (isset($_GET['action']) && $_GET['action'] === 'gm_meta_options')
														? 'active' : '';
