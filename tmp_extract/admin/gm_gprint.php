...
<html xmlns="http://www.w3.org/1999/xhtml" <?php echo HTML_PARAMS; ?>>
	...
	<body marginwidth="0" marginheight="0" topmargin="0" bottommargin="0" leftmargin="0" rightmargin="0" bgcolor="#FFFFFF">
		<?php echo xtc_draw_hidden_field('page_token', $pageToken) ?>
		<!-- header //-->
		<?php require(DIR_WS_INCLUDES . 'header.php'); ?>
		
		<script type="text/javascript" src="<?php echo DIR_WS_CATALOG; ?>gm_javascript.js.php?page=Section&section=load_gprint&globals=off&mode=backend&languages_id=<?= isset($_GET['languages_id']) ? (int)$_GET['languages_id'] : 0 ?>&id=<?= isset($_GET['id']) ? (int)$_GET['id'] : 0 ?>"></script>
			...
			<tr>
				...
				<td class="boxCenter" width="100%" valign="top">
					...
					<div class="main left-table">
						...
						elseif(isset($_GET['action']) && $_GET['action'] === 'configuration')
						{
