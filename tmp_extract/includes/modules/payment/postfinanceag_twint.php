<?php
/* -----------------------------------------------------------------------------------------
   $Id: postfinanceag_twint.php, v.2.1 swisswebXperts GmbH
...
class postfinanceag_twint_ORIGIN extends postfinance
{
    ...
    {
        $this->code = 'postfinanceag_twint';
        $this->images = array('twint');
...
MainFactory::load_origin_class('postfinanceag_twint');