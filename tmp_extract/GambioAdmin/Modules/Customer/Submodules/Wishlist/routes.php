...
return static function (RouteCollector $routeCollector) {
    $routeCollector->get('/admin/api/customer/{customerId:[0-9]+}/wishlist', GetWishlistAction::class);
    $routeCollector->delete('/admin/api/customer/{customerId:[0-9]+}/wishlist', RemoveWishlistAction::class);
};
