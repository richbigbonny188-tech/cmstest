<?php
/*--------------------------------------------------------------
   CreationOfCustomerFailedException.php 2022-01-19
   Gambio GmbH
   http://www.gambio.de
 ...
 */
class CreationOfCustomerFailedException extends Exception
{
    /**
     * @param Exception $exception
     *
     * @return CreationOfCustomerFailedException
     */
    public static function becauseOfException(Exception $exception): CreationOfCustomerFailedException
    {
