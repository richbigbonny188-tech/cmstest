<?php
/* --------------------------------------------------------------
 VisitorsDataProviderResult.php 2021-09-20
 Gambio GmbH
 http://www.gambio.de
...
class VisitorsDataProviderResult extends DataProviderResult
{
    /**
     * Constructor.
     */
    public function __construct(
        ...
        parent::__construct(new Name('visitors'), $title, $unit, $style, $minimumFractionDigits, $values);
    }
}