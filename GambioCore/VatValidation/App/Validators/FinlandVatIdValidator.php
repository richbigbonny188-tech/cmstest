<?php
/* --------------------------------------------------------------
   FinlandVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class FinlandVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class FinlandVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('fi', '', strtolower($vatId));
        if (strlen($vatId) == 10) {
