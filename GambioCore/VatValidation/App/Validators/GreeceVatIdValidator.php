<?php
/* --------------------------------------------------------------
   GreeceVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class GreeceVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class GreeceVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('el', '', strtolower($vatId));
        if (strlen($vatId) == 11) {
