<?php
/* --------------------------------------------------------------
   LatviaVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class LatviaVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class LatviaVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('lv', '', strtolower($vatId));
        if (strlen($vatId) == 13) {
