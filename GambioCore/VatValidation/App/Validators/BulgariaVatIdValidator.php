<?php
/* --------------------------------------------------------------
   BulgariaVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class BulgariaVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class BulgariaVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('bg', '', strtolower($vatId));
