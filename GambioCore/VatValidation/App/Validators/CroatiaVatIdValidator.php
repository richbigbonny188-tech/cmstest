<?php
/* --------------------------------------------------------------
   CroatiaVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class CroatiaVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class CroatiaVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('hr', '', strtolower($vatId));
        if (strlen($vatId) == 13) {
