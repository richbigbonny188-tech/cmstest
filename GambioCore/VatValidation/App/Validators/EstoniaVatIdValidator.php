<?php
/* --------------------------------------------------------------
   EstoniaVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class EstoniaVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class EstoniaVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('ee', '', strtolower($vatId));
        if (strlen($vatId) == 11) {
