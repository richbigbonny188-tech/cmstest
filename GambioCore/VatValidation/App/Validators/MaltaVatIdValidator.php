<?php
/* --------------------------------------------------------------
   MaltaVatIdValidator.php 2022-04-21
   Gambio GmbH
   http://www.gambio.de
...
/**
 * Class MaltaVatIdValidator
 *
 * @package Gambio\Core\VatValidation\App\Validators
 */
class MaltaVatIdValidator implements ManualVatIdValidator
{
    /**
     * @inheritDoc
     */
    ...
    {
        $number = str_replace('mt', '', strtolower($vatId));
        if (strlen($vatId) == 10) {
