...
if(($banktransfer['banktransfer_bankname'] ?? null) || ($banktransfer['banktransfer_blz'] ?? null)
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="gm_border dataTableRow">
	...
	elseif($banktransfer['banktransfer_fax'] ?? null)
	{
	?>
	<table border="0" width="100%" cellspacing="0" cellpadding="0" class="gm_border dataTableRow">
		<?php
		}
		if($banktransfer['banktransfer_fax'] ?? null)
		{
			?>
			<tr>
				<td width="80" class="main gm_strong" valign="top">
