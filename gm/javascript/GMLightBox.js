...
function GMLightBox()
{
	...
	jQuery.extend({
      ...
      if(jQuery('#__dimScreenIFrame').length > 0) return;
	...
	$(document).ready(function()
	{
		...
		$('.gx_microshop_lightbox').on('click', function(e)
		{
			var t_iframe_url = $(this).attr('href');
